...
import com.swbg.mlivestreaming.bean.UserInfo2Bean
...
import com.swbg.mlivestreaming.event.RefreshInfo
...
import com.swbg.mlivestreaming.ui.anchor.live.AnchorActivity
import com.swbg.mlivestreaming.ui.login_register.login.LoginViewModel
import com.swbg.mlivestreaming.ui.mine.about.AboutUsActivity
import com.swbg.mlivestreaming.ui.mine.apply.AnchorApplyActivity
import com.swbg.mlivestreaming.ui.mine.feedback.FeedBackActivity
import com.swbg.mlivestreaming.ui.mine.msg.MineMessageActivity
import com.swbg.mlivestreaming.ui.mine.relation.RelationActivity
import com.swbg.mlivestreaming.ui.mine.relation.RelationActivity.Companion.RELATION_TYPE_FANS
import com.swbg.mlivestreaming.ui.mine.relation.RelationActivity.Companion.RELATION_TYPE_FOLLOW
import com.swbg.mlivestreaming.ui.mine.self_info.SelfInfoActivity
import com.swbg.mlivestreaming.ui.mine.space.UserSpaceActivity
import com.swbg.mlivestreaming.ui.mine.system_setting.SystemSetActivity
...
import com.swbg.mlivestreaming.ui.mine.walnut.MipaWalletActivity
import com.swbg.mlivestreaming.ui.square.circle.CircleListActivity
import com.swbg.mlivestreaming.ui.square.circle.CircleListActivity.Companion.CIRCLE_TYPE_USER
import com.swbg.mlivestreaming.ui.withdraw.AnchorInfoActivity
import com.swbg.mlivestreaming.ui.withdraw.AnchorViewModel
        ...
        _getUserInfo2.observe(it, Observer {
            ...
            it?.let {it1->
                if (it1.isNotEmpty()) {
                    ...
                    ImManager.instance.getUsersInfo(arrayListOf("${TokenProvider.get().userId}"),object :V2TIMValueCallback<List<V2TIMUserFullInfo>>{
                        override fun onSuccess(p0: List<V2TIMUserFullInfo>?) {
                            if (p0 != null && p0.isNotEmpty()) {
                                ...
                                ImManager.instance.setSelfInfo(v2TIMUserFullInfo,object :V2TIMCallback{
        ...
        iv_game_walnut.singleClick {
            if (isNotNeedLogin(activity as MBaseActivity)) {
                userInfoBean.user?.wallet_url?.let {
                    activity?.let { it1 ->
                        ActivityUtils.jumpToWebView(it,
                            it1,
                            true,
