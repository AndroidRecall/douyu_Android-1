...
import com.mp.douyu.adapter.DynamicAdapter.Companion.TYPE_ADV_CONTENT
import com.mp.douyu.adapter.DynamicAdapter.Companion.TYPE_NOR_CONTENT
import com.mp.douyu.adapter.DynamicAdapter.Companion.TYPE_VIDEO_CONTENT
import com.mp.douyu.interfaces.ItemViewType
import kotlinx.android.parcel.Parcelize

@SuppressLint("ParcelCreator")
@Parcelize
data class MineMessageBean(var id: Int? = 0,
    var uid: Int? = 0,
