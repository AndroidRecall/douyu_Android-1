...
public class ChatKeyboardLayout extends SoftHandleLayout implements EmoticonsTabBarView
    ...
    public void setEtHint(int chat_msg_edit_hint) {
        etInputArea.setHint(chat_msg_edit_hint);
    }
    public void setEtHint(String chat_msg_edit_hint) {
        etInputArea.setHint(chat_msg_edit_hint);
    }
    public void setEtFilters(InputFilter[] inputFilters) {
        etInputArea.setFilters(inputFilters);
    }
    /**
        ...
        switch (event.getKeyCode()) {
            case KeyEvent.KEYCODE_BACK:
                if (lyBottomLayout != null && lyBottomLayout.isShown()) {
                    hideAutoView();
                    btnEmoticon.setSelected(false);
                    mOnChatKeyBoardListener.onBackPressed();
                    return true;
                } else {
