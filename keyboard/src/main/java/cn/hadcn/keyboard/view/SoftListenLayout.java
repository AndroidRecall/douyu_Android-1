...
public abstract class SoftListenLayout extends RelativeLayout {
    ...
    public SoftListenLayout(final Context context, AttributeSet attrs) {
        ...
        softButtonsBarHeight = getSoftButtonsBarHeight(scanForActivity(mContext));
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver
            ...
            public void onGlobalLayout() {
                Rect r = new Rect();
                scanForActivity(getContext()).getWindow().getDecorView()
                        .getWindowVisibleDisplayFrame(r);

                int screenHeight =  scanForActivity(getContext()).getWindow().getDecorView().getRootView().getHeight();
    ...
    static Activity scanForActivity(Context cont) {
        if (cont == null)
            return null;
